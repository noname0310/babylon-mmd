export class MmdDataSerializer {
    ...
    public setUint16(value: number): void {
        this._dataView.setUint16(this._offset, value, MmdDataSerializer._LittleEndian);
        this._offset += 2;
    }
    ...
    public setUint16Array(values: ArrayLike<number>): void {
        const dataView = this._dataView;
        for (let i = 0; i < values.length; ++i) {
            dataView.setUint16(this._offset, values[i], MmdDataSerializer._LittleEndian);
            this._offset += 2;
        }
    }
    ...
    public setInt32(value: number): void {
        this._dataView.setInt32(this._offset, value, MmdDataSerializer._LittleEndian);
        this._offset += 4;
    }
    ...
    public setInt32Array(values: ArrayLike<number>): void {
        const dataView = this._dataView;
        for (let i = 0; i < values.length; ++i) {
            dataView.setInt32(this._offset, values[i], MmdDataSerializer._LittleEndian);
            this._offset += 4;
        }
    }

    public setFloat32(value: number): void {
        this._dataView.setFloat32(this._offset, value, MmdDataSerializer._LittleEndian);
        this._offset += 4;
    }
