...
import type { IBuildMaterialResult, IBuildMorphResult, IMmdModelBuildGeometryResult, IMmdModelLoaderOptions } from "../mmdModelLoader.pure";
import { type IMmdModelLoadState, MmdModelLoader } from "../mmdModelLoader.pure";
...
/**
 * Register side effects for BpmxLoader
 * Safe to call multiple times; only the first call has an effect.
 */
export function RegisterBpmxLoader(): void {
    if (_Registered) {
        return;
    }
    _Registered = true;
