...
export class PBRMaterialBuilder extends MaterialBuilderBase<PBRMaterial> {
    ...
    public override loadGeneralScalarProperties(
        ...
        material.reflectionColor = new Color3(
            specular[0],
            specular[1],
            specular[2]
        );
    ...
    protected override _buildTextureNameMap(materialsInfo: readonly MaterialInfo[], materials: PBRMaterial[], imagePathTable: readonly string[], texturesInfo: readonly TextureInfo[], textureNameMap: Map<BaseTexture, string>): void {
