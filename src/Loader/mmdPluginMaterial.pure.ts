...
import type { StandardMaterial, StandardMaterialDefines } from "@babylonjs/core/Materials/standardMaterial.pure";
...
/**
 * Register side effects for MmdPluginMaterial
 * Safe to call multiple times; only the first call has an effect.
 */
export function RegisterMmdPluginMaterial(): void {
    if (_Registered) {
        return;
    }
    _Registered = true;
