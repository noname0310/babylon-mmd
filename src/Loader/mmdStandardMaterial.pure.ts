...
import type { IMmdPluginMaterial } from "./mmdPluginMaterial.pure";
import { MmdPluginMaterialSphereTextureBlendMode } from "./mmdPluginMaterial.pure";
...
/**
 * Register side effects for MmdStandardMaterial
 * Safe to call multiple times; only the first call has an effect
 */
export function RegisterMmdStandardMaterial(): void {
    if (_Registered) {
        return;
    }
    _Registered = true;
