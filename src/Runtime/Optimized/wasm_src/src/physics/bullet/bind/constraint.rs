...
extern "C" {
    ...
    fn bw_generic6dofconstraint_use_frame_offset(constraint: *mut std::ffi::c_void, frame_offset_on_off: u8);
...
impl Generic6DofConstraint {
    ...
    pub(crate) fn use_frame_offset(&mut self, frame_offset_on_off: bool) {
        unsafe { bw_generic6dofconstraint_use_frame_offset(self.ptr, frame_offset_on_off as u8) };
    }
}
