...
import TransformOrderBrokenVideo from "./transform_order_broken.mp4";

<ReactPlayer
    url={TransformOrderBrokenVideo}
    controls={true}
    width="100%"
    height="100%"/>

*This shows an example where Transform Order is incorrect. You can see that the bone at the end follows with a one-frame delay.*
...
import AppendTransformVideo from "./append_transform.mp4";

<ReactPlayer
    url={AppendTransformVideo}
    controls={true}
    width="100%"
    height="100%"/>

*This video shows Append Transform applied to shoulders used in Semi-Standard Bone Structure. Model: YYB式初音ミク_10th_v1.02 by SANMUYYB*
...
import IkVideo from "./inverse_kinematics.mp4";
...
*This video demonstrates Inverse Kinematics (IK) applied to leg movements. Model: YYB式初音ミク_10th_v1.02 by SANMUYYB*
...
import IkWithAppendTransform from "./ik_with_append_transform.mp4";

<ReactPlayer
    url={IkWithAppendTransform}
    controls={true}
    width="100%"
    height="100%"
/>

*This video demonstrates Inverse Kinematics (IK) with Append Transform applied to leg movements. Model: YYB式初音ミク_10th_v1.02 by SANMUYYB*
...
import VertexMorphVideo from "./vertex_morph.mp4";

<ReactPlayer
    url={VertexMorphVideo}
    controls={true}
    width="100%"
    height="100%"
/>

*Example of Vertex Morph that changes the face shape. Model: YYB式初音ミク_10th_v1.02 by SANMUYYB*

Vertex Morph is a **feature that changes the model's shape by modifying vertex positions**.

### Bone Morph

import BoneMorphVideo from "./bone_morph.mp4";
...
*Example of Bone Morph that moves the hand. Model: YYB式初音ミク_10th_v1.02 by SANMUYYB*
...
import MaterialMorphVideo from "./material_morph.mp4";

<ReactPlayer
    url={MaterialMorphVideo}
    controls={true}
    width="100%"
    height="100%"/>

*Example of Material Morph that turns hair shadow mesh on and off. Model: YYB式初音ミク_10th_v1.02 by SANMUYYB*
...
Group Morph is a **feature that allows multiple morphs to be grouped together and controlled as a single morph**.

## Display Frame

![display frame](./2025-08-10-183859.png)\
*List of bones and morphs displayed in MMD's timeline panel. Model: YYB式初音ミク_10th_v1.02 by SANMUYYB*
...
![physics](./2025-08-10-184326.png)\
*Physics Body Visualization in MMD (Yellow: Kinematic Rigid Body, Red: Dynamic Rigid Body) Model: YYB式初音ミク_10th_v1.02 by SANMUYYB*
